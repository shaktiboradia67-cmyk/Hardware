...
RAM: I would consider increasing RAM to ensure the game has enough memory to run smoothly, especially when other applications are open in the background
SSD (Storage): Upgrading from an HDD to an SSD would make the game load faster and reduce loading times. It can also make the PC feel more responsive overall.
Power Supply (PSU): If I install a more powerful GPU or CPU, I would check whether the existing PSU can safely provide enough power. A suitable PSU helps keep the upgraded system stable.
